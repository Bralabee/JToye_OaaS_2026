...
*   `POST /financial-transactions`: Read-only financial ledger.
*   `POST /sync/batch`: High-volume data synchronization from Edge.
*   `GET /health`: System health monitoring.

### Documentation & Context Maintenance
*   **AI Context**: `docs/AI_CONTEXT.md` serves as the source of truth for AI agents.
...
### Testing
*   **Core Java**: `./gradlew :core-java:test` (156 tests passing)
...
For detailed production deployment steps, refer to `DEPLOYMENT_GUIDE.md`.
