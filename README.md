...
[![Tests](https://img.shields.io/badge/tests-1951%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1292 `@Test` methods across 226 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
...
- **Total: 1951 logical test invocations** ✅
