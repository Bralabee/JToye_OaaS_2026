...
[![Tests](https://img.shields.io/badge/tests-2754%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1580 `@Test` methods across 256 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
...
- **Total: 2754 logical test invocations** ✅
