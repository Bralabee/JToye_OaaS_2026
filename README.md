...
[![Tests](https://img.shields.io/badge/tests-1901%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1270 `@Test` methods across 220 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
- Edge (Go): 77 `Test*` functions across 9 files ✅
- Frontend (Jest): 463 `it/test` blocks across 66 files ✅
- Frontend E2E (Playwright): 43 `test()` blocks across 13 specs ✅
- MCP server (vitest): 48 `it/test` blocks across 8 files ✅
- **Total: 1901 logical test invocations** ✅
