...
[![Tests](https://img.shields.io/badge/tests-685%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 488 `@Test` methods across 74 files ✅ (19 use Testcontainers with real Postgres + RLS, require Docker)
...
- **Total: 685 logical test invocations** ✅
