...
[![Tests](https://img.shields.io/badge/tests-2244%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Frontend (Jest): 630 `it/test` blocks across 82 files ✅
- Frontend E2E (Playwright): 63 `test()` blocks across 17 specs ✅
- MCP server (vitest): 48 `it/test` blocks across 8 files ✅
- **Total: 2244 logical test invocations** ✅
