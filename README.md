...
[![Tests](https://img.shields.io/badge/tests-1943%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1284 `@Test` methods across 223 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
...
- **Total: 1943 logical test invocations** ✅
