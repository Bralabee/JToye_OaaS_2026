...
[![Tests](https://img.shields.io/badge/tests-802%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 595 `@Test` methods across 96 files ✅ (32 use Testcontainers with real Postgres + RLS, require Docker)
- Edge (Go): 75 `Test*` functions across 8 files ✅
- Frontend (Jest): 109 `it/test` blocks across 19 files ✅
- Frontend E2E (Playwright): 23 `test()` blocks across 5 specs ✅
- **Total: 802 logical test invocations** ✅
