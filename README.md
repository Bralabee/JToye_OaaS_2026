...
[![Tests](https://img.shields.io/badge/tests-1964%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1305 `@Test` methods across 227 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
...
- **Total: 1964 logical test invocations** ✅
