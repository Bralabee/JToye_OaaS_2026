...
[![Tests](https://img.shields.io/badge/tests-2686%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Frontend (Jest): 884 `it/test` blocks across 97 files ✅
- Frontend E2E (Playwright): 95 `test()` blocks across 20 specs ✅
- MCP server (vitest): 48 `it/test` blocks across 8 files ✅
- **Total: 2686 logical test invocations** ✅
