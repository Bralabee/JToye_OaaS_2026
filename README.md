...
[![Tests](https://img.shields.io/badge/tests-2494%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1446 `@Test` methods across 245 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
- Edge (Go): 81 `Test*` functions across 11 files ✅
- Frontend (Jest): 839 `it/test` blocks across 94 files ✅
- Frontend E2E (Playwright): 80 `test()` blocks across 18 specs ✅
- MCP server (vitest): 48 `it/test` blocks across 8 files ✅
- **Total: 2494 logical test invocations** ✅
