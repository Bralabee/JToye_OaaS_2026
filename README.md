...
[![Tests](https://img.shields.io/badge/tests-2892%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1686 `@Test` methods across 267 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
- Edge (Go): 81 `Test*` functions across 11 files ✅
- Frontend (Jest): 976 `it/test` blocks across 103 files ✅
- Frontend E2E (Playwright): 101 `test()` blocks across 20 specs ✅
- MCP server (vitest): 48 `it/test` blocks across 8 files ✅
- **Total: 2892 logical test invocations** ✅

Database schema version: **V62** (Flyway).
