...
[![Tests](https://img.shields.io/badge/tests-2216%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Frontend (Jest): 616 `it/test` blocks across 81 files ✅
- Frontend E2E (Playwright): 54 `test()` blocks across 16 specs ✅
- MCP server (vitest): 48 `it/test` blocks across 8 files ✅
- **Total: 2216 logical test invocations** ✅
