...
[![Tests](https://img.shields.io/badge/tests-2751%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1578 `@Test` methods across 256 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
- Edge (Go): 81 `Test*` functions across 11 files ✅
- Frontend (Jest): 944 `it/test` blocks across 99 files ✅
- Frontend E2E (Playwright): 100 `test()` blocks across 20 specs ✅
- MCP server (vitest): 48 `it/test` blocks across 8 files ✅
- **Total: 2751 logical test invocations** ✅
