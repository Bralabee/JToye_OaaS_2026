...
[![Tests](https://img.shields.io/badge/tests-3237%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1716 `@Test` methods across 271 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
- Edge (Go): 81 `Test*` functions across 11 files ✅
- Frontend (Jest): 1272 `it/test` blocks across 124 files ✅
- Frontend E2E (Playwright): 120 `test()` blocks across 25 specs ✅
- MCP server (vitest): 48 `it/test` blocks across 8 files ✅
- **Total: 3237 logical test invocations** ✅
