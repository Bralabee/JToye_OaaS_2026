...
[![Tests](https://img.shields.io/badge/tests-2641%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1533 `@Test` methods across 255 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
...
- **Total: 2641 logical test invocations** ✅
