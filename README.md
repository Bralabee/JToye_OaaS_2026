...
[![Tests](https://img.shields.io/badge/tests-1914%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1271 `@Test` methods across 220 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
...
- **Total: 1914 logical test invocations** ✅
