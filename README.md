...
[![Tests](https://img.shields.io/badge/tests-2642%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1534 `@Test` methods across 255 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
...
- **Total: 2642 logical test invocations** ✅
