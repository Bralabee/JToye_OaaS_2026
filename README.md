...
[![Tests](https://img.shields.io/badge/tests-2225%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Frontend (Jest): 621 `it/test` blocks across 82 files ✅
- Frontend E2E (Playwright): 58 `test()` blocks across 16 specs ✅
- MCP server (vitest): 48 `it/test` blocks across 8 files ✅
- **Total: 2225 logical test invocations** ✅
