...
[![Tests](https://img.shields.io/badge/tests-2487%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1461 `@Test` methods across 248 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
- Edge (Go): 81 `Test*` functions across 11 files ✅
- Frontend (Jest): 817 `it/test` blocks across 93 files ✅
- Frontend E2E (Playwright): 80 `test()` blocks across 18 specs ✅
- MCP server (vitest): 48 `it/test` blocks across 8 files ✅
- **Total: 2487 logical test invocations** ✅
