...
[![Tests](https://img.shields.io/badge/tests-1917%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1274 `@Test` methods across 221 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
...
- **Total: 1917 logical test invocations** ✅
