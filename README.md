...
[![Tests](https://img.shields.io/badge/tests-2317%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Frontend (Jest): 696 `it/test` blocks across 87 files ✅
- Frontend E2E (Playwright): 70 `test()` blocks across 17 specs ✅
- MCP server (vitest): 48 `it/test` blocks across 8 files ✅
- **Total: 2317 logical test invocations** ✅
