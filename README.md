...
[![Tests](https://img.shields.io/badge/tests-816%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 609 `@Test` methods across 97 files ✅ (33 use Testcontainers with real Postgres + RLS, require Docker)
...
- **Total: 816 logical test invocations** ✅
