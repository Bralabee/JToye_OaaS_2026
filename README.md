...
[![Tests](https://img.shields.io/badge/tests-2275%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Frontend (Jest): 673 `it/test` blocks across 86 files ✅
- Frontend E2E (Playwright): 56 `test()` blocks across 15 specs ✅
- MCP server (vitest): 48 `it/test` blocks across 8 files ✅
- **Total: 2275 logical test invocations** ✅
