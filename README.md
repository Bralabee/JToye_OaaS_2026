...
[![Tests](https://img.shields.io/badge/tests-1976%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1317 `@Test` methods across 228 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
- Edge (Go): 77 `Test*` functions across 9 files ✅
- Frontend (Jest): 488 `it/test` blocks across 69 files ✅
- Frontend E2E (Playwright): 46 `test()` blocks across 14 specs ✅
- MCP server (vitest): 48 `it/test` blocks across 8 files ✅
- **Total: 1976 logical test invocations** ✅
