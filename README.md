...
[![Tests](https://img.shields.io/badge/tests-3317%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Frontend (Jest): 1333 `it/test` blocks across 137 files ✅
- Frontend E2E (Playwright): 122 `test()` blocks across 26 specs ✅
- MCP server (vitest): 48 `it/test` blocks across 8 files ✅
- **Total: 3317 logical test invocations** ✅
