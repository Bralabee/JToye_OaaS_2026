...
[![Tests](https://img.shields.io/badge/tests-1952%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1293 `@Test` methods across 226 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
...
- **Total: 1952 logical test invocations** ✅
