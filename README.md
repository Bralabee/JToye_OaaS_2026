...
[![Tests](https://img.shields.io/badge/tests-2769%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1595 `@Test` methods across 256 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
...
- **Total: 2769 logical test invocations** ✅
