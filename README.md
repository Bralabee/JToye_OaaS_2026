...
[![Tests](https://img.shields.io/badge/tests-1957%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1298 `@Test` methods across 227 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
...
- **Total: 1957 logical test invocations** ✅
