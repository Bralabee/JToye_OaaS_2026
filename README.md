...
[![Tests](https://img.shields.io/badge/tests-2628%20logical%20invocations-brightgreen.svg)](docs/metrics.json)
...
- Backend (Java): 1524 `@Test` methods across 255 files ✅ (Testcontainers with real Postgres + RLS, require Docker)
- Edge (Go): 81 `Test*` functions across 11 files ✅
- Frontend (Jest): 880 `it/test` blocks across 97 files ✅
- Frontend E2E (Playwright): 95 `test()` blocks across 20 specs ✅
- MCP server (vitest): 48 `it/test` blocks across 8 files ✅
- **Total: 2628 logical test invocations** ✅
