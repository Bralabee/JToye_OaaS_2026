...
| P3-12 unused JasperReports in prod JAR | **RESOLVED** | `core-java/build.gradle.kts:171-176` — comment records removal 2026-07-27: zero imports, zero `.jrxml`/`.jasper` templates existed; also closed 3 CVEs (beanutils + 2 jasper CVEs). |
