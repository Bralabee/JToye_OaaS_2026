---
applyTo: docs/metrics.json, .github/workflows/**, qa/**, **/*Test*.java, **/*.spec.ts
---

<!-- GENERATED by jtoye-orgos scripts/sync_agents.py from charters/oaas-release-qa.md.
     Edit the charter, then run `make agents`. Edits here are overwritten. -->

# oaas-release-qa

These instructions attach automatically when a file matching `docs/metrics.json, .github/workflows/**, qa/**, **/*Test*.java, **/*.spec.ts` is in context.
