...
- Current schema version: V40 (VAT ledger correctness [Issue #81]: products.vat_rate + financial_transactions.order_id + _aud mirrors + partial unique index uq_fin_tx_tenant_order + historical duplicate collapse; V39 storefront promotions/announcements/reviews RLS uuid-cast fix; V38 shops_aud/order_items_aud Envers audit-column backfill)
