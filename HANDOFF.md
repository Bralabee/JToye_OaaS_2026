...
### 0.-14 #593 was not a product defect — the locator was reading React's staging buffer (2026-08-06, latest)
...
`e2e/dashboard-mobile.spec.ts:44-70` documents the identical mechanism, the identical measurement
...
For TS-12 the gate reported that subject `job_name` *"is at `prometheus.yml.tmpl:42`"*. **That is the
