    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="bg-white border-b border-slate-200">
        <div className="mx-auto max-w-lg px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <span className="inline-flex h-7 w-7 items-center justify-center rounded-lg bg-orange-500 text-xs font-bold text-white">J</span>
      ...
      <div className="mx-auto max-w-lg px-4 py-8">
        ...
        <form onSubmit={handleSearch} className="rounded-xl bg-white border border-slate-100 p-5 shadow-sm">
          <h1 className="text-base font-bold text-slate-900 mb-4">Find your order</h1>
