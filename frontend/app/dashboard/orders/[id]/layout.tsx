 ...
 *
 * The order number itself is not in the title: resolving it would mean fetching
 * the order on the server purely to name the tab, on a route that already
 * fetches it on the client.
 */
export const metadata: Metadata = {
  title: "Order detail — J'Toye OaaS",
}
