      ...
      <header className="border-b-[3px] border-oxblood bg-oxblood text-slate-50 print:bg-white print:text-slate-900">
        ...
        >
          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-[1.3fr_0.7fr] lg:items-end">
            <div>
              <p className="mb-4 text-xs uppercase tracking-[0.2em] text-amber-300">A decision, not a pitch</p>
          ...
          <div className="mt-10 grid grid-cols-3 border-t border-oxblood/30 text-center text-xs uppercase tracking-[0.12em] sm:text-xs">
            <div className="border-r border-oxblood/30 px-2 py-4">Daily takeaway</div>
            <div className="border-r border-oxblood/30 px-2 py-4">Event catering</div>
      ...
      <nav aria-label="Guide topics" className="sticky top-0 z-30 border-b border-slate-200 bg-cream/95 backdrop-blur print:static">
        ...
        >
          ...
          <div className="ml-auto hidden shrink-0 gap-2 sm:flex print:hidden">
            <a href="/for-operators" className="inline-flex items-center rounded-full border border-oxblood/30 px-3 py-1.5 text-sm font-semibold hover:bg-cream focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500">Operator pitch</a>
            <a href="/competitive" className="inline-flex items-center rounded-full border border-oxblood/30 px-3 py-1.5 text-sm font-semibold hover:bg-cream focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500">How we compare</a>
            <button type="button" onClick={copyLink} className="inline-flex items-center gap-2 rounded-full border border-oxblood/30 px-3 py-1.5 text-sm font-semibold hover:bg-cream focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500"><Copy size={15} /> Copy link</button>
            <a href="/business-model-guide.pdf" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full bg-oxblood px-3 py-1.5 text-sm font-semibold text-white hover:bg-oxblood-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500"><Printer size={15} /> Print / save PDF</a>
          </div>
        </div>
      </nav>
