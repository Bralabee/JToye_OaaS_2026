...
interface SheetContentProps
  ...
  /**
   * Hide the built-in top-right close button. Consumers that render their own
   * explicitly-labelled close control (e.g. the public mobile nav's
   * "Close menu") set this to avoid a duplicate close affordance.
   */
